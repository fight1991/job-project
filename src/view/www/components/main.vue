      ...
      <div class="pro">
        ...
        <div class="detail clearfix">
          <div class="item" v-for="item in pro" :key="item.imgURL">
            <i :class="['www-icon',item.imgIcon]"></i>
      ...
      <div class="content mainer">
        ...
        <div class="detail clearfix">
          <div class="item first">
            <img src="https://www.5itrade.cn/files/CCBA/intel01.png" alt="">
          </div>
          <div class="item text">
          ...
          <div class="item">
            <img src="https://www.5itrade.cn/files/CCBA/intel02.png" alt="">
          </div>
          <div class="item">
            <img src="https://www.5itrade.cn/files/CCBA/intel03.png" alt="">
          </div>
          <div class="item text">
          ...
          <div class="item">
            <img src="https://www.5itrade.cn/files/CCBA/intel04.png" alt="">
          </div>
          <div class="item text">
...
.order {
  height: 155px;
  padding-top: 50px;
  background: url('https://www.5itrade.cn/files/CCBA/contact.png') no-repeat center;
